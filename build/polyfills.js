System.registerDynamic("github:frankwallis/plugin-typescript@4.0.10.json", [], false, function() {
  return {
    "main": "plugin",
    "format": "register"
  };
...
System.register('src/bundles/polyfills.ts', ['zone.js', 'reflect-metadata'], function (_export, _context) {
  return {
    setters: [function (_zoneJs) {}, function (_reflectMetadata) {}],
    execute: function () {}
  };
});
